...
const searchUsers = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const allUsers = (yield (0, db_1.query)('SELECT id, username, email, is_admin FROM users WHERE LOWER(username) LIKE $1 OR LOWER(email) LIKE $2 AND id != $3;', [
        // @ts-ignore
    ...
    const users = (yield (0, db_1.query)('SELECT id, username, email, is_admin FROM users WHERE (LOWER(username) LIKE $1 OR LOWER(email) LIKE $2) AND id != $3 OFFSET $4 LIMIT $5;', [
        // @ts-ignore
...
const updateUserStatus = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { id } = req.params;
    const updatedUser = (yield (0, db_1.query)('UPDATE users SET is_admin = $1 WHERE id = $2 RETURNING id, is_admin, username, email;', [isAdmin, id])).rows[0];
