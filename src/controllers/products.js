...
const getStats = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const oldUsers = (yield (0, db_1.query)('SELECT COUNT(*) FROM users WHERE extract(month FROM created_at) = extract(month FROM CURRENT_DATE) - 1;', [])).rows[0];
    ...
    const oldOrders = (yield (0, db_1.query)('SELECT COUNT(*) FROM orders WHERE extract(month FROM created_at) = extract(month FROM CURRENT_DATE) - 1;', [])).rows[0];
    ...
    const oldMessages = (yield (0, db_1.query)('SELECT COUNT(*) FROM messages WHERE extract(month FROM created_at) = extract(month FROM CURRENT_DATE) - 1;', [])).rows[0];
